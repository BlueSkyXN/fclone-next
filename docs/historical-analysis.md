...
开发线的上游提交 `c99b2d11e`。项目做行为级复刻，不追求旧实现的逐行移植或
...
| 当前实现基线 | [`rclone/rclone@c99b2d11`](https://github.com/rclone/rclone/commit/c99b2d11edb0986cd2b1190e9fa25a58a3f12661) | rclone v1.75.0 development line，2026-07-24 |
